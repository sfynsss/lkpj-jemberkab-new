...
class RKPDBidangController extends Controller
{
    public function listSKPD(){
        $data = SKPD::where('id_bidang', Auth::user()->id)->get();
        return view('pages.bidang.rkpd.list_skpd', compact('data'));
    }
    ...
    public function program($id_skpd){
        ...
        return view('pages.bidang.rkpd.program', compact('data', 'nama'));
    }
    ...
    public function kegiatan($i){
        ...
        return view('pages.bidang.rkpd.kegiatan', compact('data', 'nama'));
    }
    ...
    public function subkegiatan($i){
        ...
        return view('pages.bidang.rkpd.subkegiatan', compact('data', 'nama'));
    }
}
