...
class PredikatBidangController extends Controller
{
    public function listSKPD(){
        $data = SKPD::where('id_bidang', Auth::user()->id)->get();
        return view('pages.bidang.predikat.list_skpd', compact('data'));
    }

    public function predikat($id_skpd){
        ...
        $nama = Skpd::where('id', $id_skpd)->value('nama_skpd');

        $ke_predikat_1 = Predikat::where('id_skpd', $id_skpd)->where('triwulan_predikat', 1)->where('tahun_predikat', "202".$tahun_aktif)->value('id');
        $ke_predikat_2 = Predikat::where('id_skpd', $id_skpd)->where('triwulan_predikat', 2)->where('tahun_predikat', "202".$tahun_aktif)->value('id');
        $ke_predikat_3 = Predikat::where('id_skpd', $id_skpd)->where('triwulan_predikat', 3)->where('tahun_predikat', "202".$tahun_aktif)->value('id');
        $ke_predikat_4 = Predikat::where('id_skpd', $id_skpd)->where('triwulan_predikat', 4)->where('tahun_predikat', "202".$tahun_aktif)->value('id');

        $sub_keg = SubKegiatan::where('id_skpd', $id_skpd)->get();
        ...
        return view('pages.bidang.predikat.predikat', compact('nama', 'tahun_aktif',
    ...
    public function verifikasi($id) {
        ...
        $data = SubKegiatan::where('id_skpd', $skpd);
        $sub_keg = SubKegiatan::where('id_skpd', $skpd)->get();
        ...
        return view('pages.bidang.predikat.verifikasi', compact('predikat', 'triwulan', 
        'ps_kinerja1', 'pr_kinerja1','ps_anggaran1', 'pr_anggaran1',
        'ps_kinerja2', 'pr_kinerja2','ps_anggaran2', 'pr_anggaran2',
        'ps_kinerja3', 'pr_kinerja3','ps_anggaran3', 'pr_anggaran3',
    ...
    public function update(Request $request) {
        $data = Predikat::where('id', $request->id)->update([
            'tindak_lanjut_triwulan'   => $request->tindak_lanjut_triwulan,
            'tindak_lanjut_rkpd'   => $request->tindak_lanjut_rkpd,
        ]);
        return Redirect::back()->with('warning', 'Data Berhasil Diverifikasi');
    }
