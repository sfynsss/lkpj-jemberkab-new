	...
	<table border="0" width="100%">
		...
		<tr>
			<td width="100%" align="center">
				<div class="chapter2" style="text-align: center; border-bottom: 0px solid #000000; font-weight: bold; font-size: 10pt">EVALUASI TERHADAP HASIL RKPD<br>PEMERINTAH KABUPATEN JEMBER<br>TAHUN {{ Cookie::get('tahun_aktif') }} TRIWULAN {{$tw}}</div>
			</td>
		</tr>
	</table>	
	...
	<table class="gridtable">
		<thead>
			<tr>
				...
				<th width="7%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Target RPJMD <br>Kabupaten/Kota<br>pada<br>Tahun {{ Cookie::get('tahun_aktif') }}</span></th>
					<th width="8%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Realisasi<br>Capaian Kinerja<br>RPJMD<br>Kabupaten/Kota<br>sampai dengan<br>RKPD<br>Kabupaten/Kota<br>Tahun {{ Cookie::get('tahun_aktif') }}</b></span></th>
					<th width="8%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Target Kinerja<br>dan Anggaran<br>RKPD<br>Kabupaten/Kota<br>Tahun {{ Cookie::get('tahun_aktif') }}<br>yang dievaluasi</b></span></th>
					...
					<th width="7%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Realisasi<br>Kinerja dan<br>Anggaran<br>RPJMD<br>Kabupaten/Kota<br>s/d Tahun {{ Cookie::get('tahun_aktif') }}<br></b></span></th>	
					<th width="4%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Tingkat Capaian<br>Kinerja dan<br>Realisasi<br>Anggaran<br>RPJMD<br>Kabupaten/Kota<br>s/d tahun {{ Cookie::get('tahun_aktif') }}<br>(%)</b></span></th>
			...
			<tbody>
				...
				<tr>
					...
					<td align=left><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">{{Auth::user()->Skpd->kode_skpd}}</span></td>
					<td align=left colspan="25"><span style="font-size: 6pt;font-weight:bold;font-family: Arial;"></span>{{Auth::user()->Skpd->nama_skpd}}</td>
				</tr>
				...
				@if(isset($bidang->Program[0]) && $bidang->Program[0]->id_skpd == Auth::user()->id_skpd)
				<tr>
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">{{$tmp+=1}}</span></td>
					<td align=right><span style="font-size: 6pt;font-weight:bold;font-family: Arial;"></span></td>
				...
				@if($program->id_skpd == Auth::user()->id_skpd)
				...
				<tr>
					...
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">{{ $target = $sub_kegiatan->target_sub_keg_2 }}</span></td>
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">@currency( $pagu = $sub_kegiatan->pagu_indikatif_sub_keg_2)</span></td>
					@elseif (substr(Cookie::get('tahun_aktif'), 3) == 3)
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">{{ $target = $sub_kegiatan->target_sub_keg_3 }}</span></td>
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">@currency( $pagu = $sub_kegiatan->pagu_indikatif_sub_keg_3)</span></td>
					@elseif (substr(Cookie::get('tahun_aktif'), 3) == 4)
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">{{ $target = $sub_kegiatan->target_sub_keg_4 }}</span></td>
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">@currency( $pagu = $sub_kegiatan->pagu_indikatif_sub_keg_4)</span></td>
					@elseif (substr(Cookie::get('tahun_aktif'), 3) == 5)
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">{{ $target = $sub_kegiatan->target_sub_keg_5 }}</span></td>
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">@currency( $pagu = $sub_kegiatan->pagu_indikatif_sub_keg_5)</span></td>
					@elseif (substr(Cookie::get('tahun_aktif'), 3) == 6)
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">{{ $target = $sub_kegiatan->target_sub_keg_6 }}</span></td>
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">@currency( $pagu = $sub_kegiatan->pagu_indikatif_sub_keg_6)</span></td>
					@endif
					@if($tw == 1)
				...
				<tr>
					...
					<td colspan="24" align=left><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">
						{{\App\Predikat::where(['id_skpd' => Auth::user()->id_skpd, 'triwulan_predikat' => $tw, 'tahun_predikat' => Cookie::get('tahun_aktif')])->pluck('faktor_pendorong')->first()}}
					</span></td>
				</tr>
				<tr>
					...
					<td colspan="24" align=left><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">
						{{\App\Predikat::where(['id_skpd' => Auth::user()->id_skpd, 'triwulan_predikat' => $tw, 'tahun_predikat' => Cookie::get('tahun_aktif')])->pluck('faktor_penghambat')->first()}}
					</span></td>
				</tr>
				<tr>
					...
					<td colspan="24" align=left><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">
						{{\App\Predikat::where(['id_skpd' => Auth::user()->id_skpd, 'triwulan_predikat' => $tw, 'tahun_predikat' => Cookie::get('tahun_aktif')])->pluck('tindak_lanjut_triwulan')->first()}}
					</span></td>
				</tr>
				<tr>
					...
					<td colspan="24" align=left><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">
						{{\App\Predikat::where(['id_skpd' => Auth::user()->id_skpd, 'triwulan_predikat' => $tw, 'tahun_predikat' => Cookie::get('tahun_aktif')])->pluck('tindak_lanjut_rkpd')->first()}}
					</span></td>
				</tr>
			</tbody>
		</table>
		...
		<table style="page-break-inside:avoid; page-break-after:auto" border="0" width="60%" align="right">
			...
			<tr>
				<td><span style="font-size: 7pt;font-family: Arial;font-style:normal;font-weight: normal;">Jember, {{ \Carbon\Carbon::parse($tgl_susun)->format('d M Y') }}</span></td><td></td><td><span style="font-size: 7pt;font-family: Arial;font-style:normal;font-weight: normal;">Jember, {{ \Carbon\Carbon::parse($tgl_setuju)->format('d M Y') }}</span></td>
			</tr>
			<tr>
				<td><span style="font-size: 7pt;font-family: Arial;font-style:normal;font-weight: normal;">KEPALA {{ Auth::user()->Skpd->nama_skpd	}}</span></td><td></td><td><span style="font-size: 7pt;font-family: Arial;font-style:normal;font-weight: normal;">KEPALA BADAN PERENCANAAN DAN PEMBANGUNAN DAERAH</span></td>
			</tr>	
			...
			<tr><td colspan="3"></td></tr>
			<tr>
				<td><span style="font-size: 7pt;font-family: Arial;font-style:normal;font-weight: normal;">{{ Auth::user()->nama}}</span></td><td></td><td><span style="font-size: 7pt;font-family: Arial;font-style:normal;font-weight: normal;">Drs. HADI MULYONO, M.Si</span></td>
			</tr>
			<tr>
				<td><span style="font-size: 7pt;font-family: Arial;font-style:normal;font-weight: normal;">NIP. {{ Auth::user()->nip }}</span></td><td></td><td><span style="font-size: 7pt;font-family: Arial;font-style:normal;font-weight: normal;">NIP. 19661107 198809 1 001</td>
				</tr>
			</table>
