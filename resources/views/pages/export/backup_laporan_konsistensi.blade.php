        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="24" align=left><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">
                    {{\App\Predikat::where(['id_skpd' => Auth::user()->id_skpd, 'triwulan_predikat' => $tw])->pluck('faktor_pendorong')->first()}}
                </span></td>
            </tr>
            <tr>
                ...
                <td colspan="24" align=left><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">
                    {{\App\Predikat::where(['id_skpd' => Auth::user()->id_skpd, 'triwulan_predikat' => $tw])->pluck('faktor_penghambat')->first()}}
                </span></td>
            </tr>
            <tr>
                ...
                <td colspan="24" align=left><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">
                    {{\App\Predikat::where(['id_skpd' => Auth::user()->id_skpd, 'triwulan_predikat' => $tw])->pluck('tindak_lanjut_triwulan')->first()}}
                </span></td>
            </tr>
            <tr>
                ...
                <td colspan="24" align=left><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">
                    {{\App\Predikat::where(['id_skpd' => Auth::user()->id_skpd, 'triwulan_predikat' => $tw])->pluck('tindak_lanjut_rkpd')->first()}}
                </span></td>
            </tr>
        </tbody>
    </table>
