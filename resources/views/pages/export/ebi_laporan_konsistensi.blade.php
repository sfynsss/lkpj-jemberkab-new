	...
	<table border="0" width="100%">
		...
		<tr>
			<td width="100%" align="center">
				<div class="chapter2" style="text-align: center; border-bottom: 0px solid #000000; font-weight: bold; font-size: 10pt">EVALUASI TERHADAP HASIL RKPD<br>PEMERINTAH KABUPATEN JEMBER<br>TAHUN 2021 TRIWULAN {{$tw}}</div>
			</td>
		</tr>
	</table>	
	<table class="gridtable">
		<thead>
			<tr>
				...
				<th width="7%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Target RPJMD <br>Kabupaten/Kota<br>pada<br>Tahun 2021</span></th>
					<th width="8%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Realisasi<br>Capaian Kinerja<br>RPJMD<br>Kabupaten/Kota<br>sampai dengan<br>RKPD<br>Kabupaten/Kota<br>Tahun 2020</b></span></th>
					<th width="8%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Target Kinerja<br>dan Anggaran<br>RKPD<br>Kabupaten/Kota<br>Tahun 2021<br>yang dievaluasi</b></span></th>
					...
					<th width="7%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Realisasi<br>Kinerja dan<br>Anggaran<br>RPJMD<br>Kabupaten/Kota<br>s/d Tahun 2021<br></b></span></th>	
					<th width="4%" colspan="2" rowspan="2" align="center"><span style="font-size: 7pt;font-family:Tahoma;font-weight: normal;"><b>Tingkat Capaian<br>Kinerja dan<br>Realisasi<br>Anggaran<br>RPJMD<br>Kabupaten/Kota<br>s/d tahun 2021<br>(%)</b></span></th>
			...
			<tbody>
				...
				@if (substr(Cookie::get('tahun_aktif'), 3) == 1)
					...
					$x = $sub_kegiatan->pagu_indikatif_sub_keg_1;
					@endphp
				@elseif (substr(Cookie::get('tahun_aktif'), 3) == 2)
					...
					$x = $sub_kegiatan->pagu_indikatif_sub_keg_2;
					@endphp
				@elseif (substr(Cookie::get('tahun_aktif'), 3) == 3)
					...
					$x = $sub_kegiatan->pagu_indikatif_sub_keg_3;
					@endphp
				@elseif (substr(Cookie::get('tahun_aktif'), 3) == 4)
					...
					$x = $sub_kegiatan->pagu_indikatif_sub_keg_4;
					@endphp
				@elseif (substr(Cookie::get('tahun_aktif'), 3) == 5)
					...
					$x = $sub_kegiatan->pagu_indikatif_sub_keg_5;
					@endphp
				@elseif (substr(Cookie::get('tahun_aktif'), 3) == 6)
					...
					$x = $sub_kegiatan->pagu_indikatif_sub_keg_6;
					@endphp
				@endif
				...
				<tr>
					...
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">@currency( $pagu = $x)</span></td>
					@if($tw == 1)
					<td align=center><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">
