...
<div class="page-inner">
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">Laporan per Lokasi</li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
            ...
            <table id="basic-datatables" class="display table table-striped table-hover" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="{{ route('laporan-lokasi-cetak') }}" class="btn btn-primary"><i class="fas fa-desktop btn-icon-prepend mr-2"></i>Cetak Laporan</td>
                </tr>
                <tr>
                  <td>2</td>
                  <td>1.2.1.1</td>
