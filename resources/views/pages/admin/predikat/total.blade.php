...
<div class="page-inner">
  <div class="page-header">
    <h4 class="page-title">Predikat Total</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">Predikat Total</li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12 col-md-12 text-center">
                    <h3 class="text-dark font-weight-bold mb-2">Grafik Predikat Total</h3>
                    <h5 class="font-weight-normal mb-2">Berikut grafik predikat total kinerja dan anggaran dari SKPD :</h5>
                </div>
            </div>
            <div class="row mt-4">
