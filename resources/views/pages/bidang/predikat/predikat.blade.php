              ...
              <tbody>
                  <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('predikat-verifikasi-bidang', $ke_predikat_1) }}" class="btn btn-success">Verifikasi Capain Triwulan I</a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('predikat-verifikasi-bidang', $ke_predikat_2) }}" class="btn btn-success">Verifikasi Capain Triwulan II</a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('predikat-verifikasi-bidang', $ke_predikat_3) }}" class="btn btn-success">Verifikasi Capain Triwulan III</a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('predikat-verifikasi-bidang', $ke_predikat_4) }}" class="btn btn-success">Verifikasi Capain Triwulan IV</a>
                    </td>
                  </tr>
              </tbody>
            </table>
