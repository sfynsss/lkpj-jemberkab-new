...
@include('pages.bidang.sippd.detail_subkegiatan')
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{ route('sippd-subkegiatan-bidang-edit', $data->id) }}" class="btn btn-warning"><i class="fas fa-pen btn-icon-prepend mr-2"></i>Ubah Data</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
