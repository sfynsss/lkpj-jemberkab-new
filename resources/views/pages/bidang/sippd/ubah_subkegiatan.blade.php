                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="realisasi_sub_keg_1_1" value="{{ $sub_kegiatan->realisasi_sub_keg_1_1 }}" placeholder="Isikan kinerja triwulan ke 1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="realisasi_sub_keg_1_2" value="{{ $sub_kegiatan->realisasi_sub_keg_1_2}}" placeholder="Isikan kinerja triwulan ke 2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="realisasi_sub_keg_1_3" value="{{ $sub_kegiatan->realisasi_sub_keg_1_3 }}" placeholder="Isikan kinerja triwulan ke 3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="realisasi_sub_keg_1_4" value="{{ $sub_kegiatan->realisasi_sub_keg_1_4 }}" placeholder="Isikan kinerja triwulan ke 4">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="serapan_sub_keg_1_1" value="{{ $sub_kegiatan->serapan_sub_keg_1_1 }}" placeholder="Isikan serapan triwulan ke 1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="serapan_sub_keg_1_2" value="{{ $sub_kegiatan->serapan_sub_keg_1_2 }}" placeholder="Isikan serapan triwulan ke 2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="serapan_sub_keg_1_3" value="{{ $sub_kegiatan->serapan_sub_keg_1_3 }}" placeholder="Isikan serapan triwulan ke 3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="serapan_sub_keg_1_4" value="{{ $sub_kegiatan->serapan_sub_keg_1_4 }}" placeholder="Isikan serapan triwulan ke 4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group row col-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="masalah_sub_keg_1_1" value="{{ $sub_kegiatan->masalah_sub_keg_1_1 }}" placeholder="Tulis masalah pada triwulan ke 1">
                                ...
                                <div class="form-group row col-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="solusi_sub_keg_1_1" value="{{ $sub_kegiatan->solusi_sub_keg_1_1 }}" placeholder="Tulis solusi pada triwulan ke 1">
                            ...
                            <div class="row">
                                <div class="form-group row col-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="masalah_sub_keg_1_2" value="{{ $sub_kegiatan->masalah_sub_keg_1_2 }}" placeholder="Tulis masalah pada triwulan ke 2">
                                ...
                                <div class="form-group row col-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="solusi_sub_keg_1_2" value="{{ $sub_kegiatan->solusi_sub_keg_1_2 }}" placeholder="Tulis solusi pada triwulan ke 2">
                            ...
                            <div class="row">
                                <div class="form-group row col-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="masalah_sub_keg_1_3" value="{{ $sub_kegiatan->masalah_sub_keg_1_3 }}" placeholder="Tulis masalah pada triwulan ke 3">
                                ...
                                <div class="form-group row col-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="solusi_sub_keg_1_3" value="{{ $sub_kegiatan->solusi_sub_keg_1_3 }}" placeholder="Tulis solusi pada triwulan ke 3">
                            ...
                            <div class="row">
                                <div class="form-group row col-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="masalah_sub_keg_1_4" value="{{ $sub_kegiatan->masalah_sub_keg_1_4 }}" placeholder="Tulis masalah pada triwulan ke 4">
                                ...
                                <div class="form-group row col-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="solusi_sub_keg_1_4" value="{{ $sub_kegiatan->solusi_sub_keg_1_4 }}" placeholder="Tulis solusi pada triwulan ke 4">
