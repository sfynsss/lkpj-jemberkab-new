    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('predikat-update-opd') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" name="faktor_pendorong" class="form-control" value="{{ $predikat->faktor_pendorong }}" placeholder="Tulis faktor pendorong capaian pada triwulan terpilih">
                    @error('faktor_pendorong')<span><code>{{ $message }}</code></span>@enderror
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-2 col-form-label">Faktor Penghambat</label>
                <div class="col-lg-10">
                    <input type="text" name="faktor_penghambat" class="form-control" value="{{ $predikat->faktor_penghambat }}" placeholder="Tulis faktor penghambat capaian pada triwulan terpilih">
                    @error('faktor_penghambat')<span><code>{{ $message }}</code></span>@enderror
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" value="{{ $predikat->tindak_lanjut_triwulan }}" disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-lg-2 col-form-label">Tindak Lanjut RKPD</label>
                  <div class="col-lg-10">
                    <input type="text" class="form-control" value="{{ $predikat->tindak_lanjut_rkpd }}" disabled>
                </div>
            </div>
            <hr>
            <div class="mt-2 float-right">
              <a href="{{ route('predikat-opd') }}" class="btn btn-light mr-2">Kembali</a>
