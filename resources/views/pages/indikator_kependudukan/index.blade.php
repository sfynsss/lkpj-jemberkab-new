                  ...
                  <tbody>
                    @foreach ($data as $dt)
                        <tr>
                            ...
                            <td class="text-center">{{ $dt->tahun_2017 }}</td>
                            <td class="text-center">{{ $dt->tahun_2018 }}</td>
                            <td class="text-center">{{ $dt->tahun_2019 }}</td>
                            <td class="text-center">{{ $dt->tahun_2020 }}</td>
                            <td class="text-center">{{ $dt->tahun_2021 }}</td>
                            <td class="text-center">{{ $dt->tahun_2022 }}</td>
                            <td class="text-center">{{ $dt->tahun_2023 }}</td>
                        </tr>
                    @endforeach
                  </tbody>
                </table>
