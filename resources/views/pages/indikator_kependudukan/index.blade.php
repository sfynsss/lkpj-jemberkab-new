...
<div class="row">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="waves-effect waves-warning btn btn-warning btn-circle btn-sm" 
                                        data-bs-toggle="modal" data-bs-target=".modal-ubah-indikator" 
                                        onclick="insertTextIndikator('{{ $dt->id }}', '{{ $dt->nama_data }}', 
  ...
  <div class="modal fade modal-ubah-indikator" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <form class="modal-content" action="{{ route('indikator-kependudukan-update') }}" method="POST">
        <div class="modal-header">
          <h4 class="modal-title" id="myLargeModalLabel">Form Ubah Data Indikator Kependudukan</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          @csrf
          <input type="number" id="id_indikator" name="id_indikator" required hidden>
  ...
  <script>
    function insertTextIndikator($a,$b,$c,$d, $e,$f,$g,$h,$i)
    {
        document.getElementById('id_indikator').value = $a;
