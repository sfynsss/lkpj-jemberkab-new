      ...
      <div class="box-body bg-img" style="background-image: url(../images/bg-5.png);" data-overlay-light="9">
        <div class="d-lg-flex align-items-center justify-content-between">
          <div class="d-md-flex align-items-center mb-30 mb-lg-0 w-p100">
            ...
            <div class="ms-30">
              <h3 class="mb-10"><b>Bab. II Daftar SKPD</b></h3>
            </div>
          </div>
        </div>							
      </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="{{ route('program-pks', $data->id) }}" class="btn bg-gradient-primary">Lihat</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
                ...
                <tbody>
                  @foreach ($data as $i => $data)
                      <tr>
                        ...
                        <td>{{ $data->nama_skpd }}</td>
                        <td class="text-center">
                          <a href="{{ route('program-pks', $data->id) }}" class="btn btn-outline-primary">Lihat</a>
                        </td>
                      </tr>
                  @endforeach
                </tbody>
