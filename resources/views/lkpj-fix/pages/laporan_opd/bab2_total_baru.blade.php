        ...
        {{-- <div class="wrapper"> --}}
            <table class="gridtable">
                ...
                <tbody>
                    ...
                    @if($realisasi != 0) 
                    <tr>
                        <td class="text-left text-top"><span style="font-size: 6pt; margin-left:7px;font-family: Arial;">{{ $sub_kegiatan->kode_sub_keg }}</span></td>
                        <td colspan="2" class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->nama_sub_keg }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;"></span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->indikator_sub_keg }}</span></td>
                        @if (substr(Cookie::get('tahun_aktif'), 3) == 1)
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $sub_kegiatan->target_sub_keg_1 }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($sub_kegiatan->pagu_indikatif_sub_keg_1)</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $realisasi }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($serapan)</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->masalah_sub_keg_1_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->solusi_sub_keg_1_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;"></span></td>
                        @elseif (substr(Cookie::get('tahun_aktif'), 3) == 2)
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $sub_kegiatan->target_sub_keg_2 }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($sub_kegiatan->pagu_indikatif_sub_keg_2)</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $realisasi }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($serapan)</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->masalah_sub_keg_2_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->solusi_sub_keg_2_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;"></span></td>
                        @elseif (substr(Cookie::get('tahun_aktif'), 3) == 3)
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $sub_kegiatan->target_sub_keg_3 }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($sub_kegiatan->pagu_indikatif_sub_keg_3)</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $realisasi }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($serapan)</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->masalah_sub_keg_3_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->solusi_sub_keg_3_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;"></span></td>
                        @elseif (substr(Cookie::get('tahun_aktif'), 3) == 4)
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $sub_kegiatan->target_sub_keg_4 }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($sub_kegiatan->pagu_indikatif_sub_keg_4)</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $realisasi }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($serapan)</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->masalah_sub_keg_4_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->solusi_sub_keg_4_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;"></span></td>
                        @elseif (substr(Cookie::get('tahun_aktif'), 3) == 5)
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $sub_kegiatan->target_sub_keg_5 }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($sub_kegiatan->pagu_indikatif_sub_keg_5)</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $realisasi }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($serapan)</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->masalah_sub_keg_5_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->solusi_sub_keg_5_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;"></span></td>
                        @elseif (substr(Cookie::get('tahun_aktif'), 3) == 6)
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $sub_kegiatan->target_sub_keg_6 }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($sub_kegiatan->pagu_indikatif_sub_keg_6)</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">{{ $realisasi }}</span></td>
                        <td><span style="font-size: 6pt; font-weight:bold;font-family: Arial;">@currency($serapan)</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->masalah_sub_keg_6_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $sub_kegiatan->solusi_sub_keg_6_4 }}</span></td>
                        <td class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;"></span></td>
                        @endif
                    </tr>
                    @endif
