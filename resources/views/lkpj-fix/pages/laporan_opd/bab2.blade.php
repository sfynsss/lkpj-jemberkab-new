  ...
  <div class="print">
    ...
    {{-- <div class="wrapper"> --}}
      <table class="gridtable">
        ...
        <tbody>
          @foreach ($urusan->BidangUrusan as $bidangUrusan)
          @foreach ($bidangUrusan->Program as $program)
          @if ($program->id_skpd == Request::segment(3))
          <tr>
            <td class="text-left text-top"><span style="font-size: 6pt; margin-left:7px;font-weight:bold;font-family: Arial;">{{ $program->kode_program }}</span></td>
            <td colspan="1" class="text-left text-top"><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">{{ $program->nama_program }}</span></td>
            <td colspan="7" class="text-left text-top"><span style="font-size: 6pt;font-weight:bold;font-family: Arial;">{{ $program->indikator_program }}</span></td>
            {{-- <td colspan="6" class="text-left text-top"><span style="font-size: 6pt;font-weight:bold;font-family: Arial;"></span></td> --}}
          </tr>
          @foreach ($program->Kegiatan as $kegiatan)
          <tr>
            <td class="text-left text-top"><span style="font-size: 6pt; margin-left:7px;font-family: Arial;">{{ $kegiatan->kode_kegiatan }}</span></td>
            <td colspan="1" class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $kegiatan->nama_kegiatan }}</span></td>
            <td colspan="7" class="text-left text-top"><span style="font-size: 6pt;font-family: Arial;">{{ $kegiatan->indikator_kegiatan }}</span></td>
            {{-- <td colspan="6" class="text-left text-top"><span style="font-size: 6pt;font-weight:bold;font-family: Arial;"></span></td> --}}
          </tr>
